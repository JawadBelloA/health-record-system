...
class SaveRecords extends Database
{
    ...
    ($HospitalNumber,$patientName,$regDate,$refferedFrom,$refferedDate, $otherName,$middleName,$occupation,$address,$patientGSM, $nationality,$placeOfBirth,$stateOfOrigin,$tribe,$religion,$employer,$sex,$insuranceStatus,$maritalStatus,$HMO,$nextOfKin,$addressOfNOK,$GSMofNOK,$relationship){
